...
BOT_TOKEN = environ.get('BOT_TOKEN', "8026281189:AAEvhSuSZTA2QsZZ1bQhARjpibisXw5p0mA-5Fc_4")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002289263173').split()] #Channel id for auto indexing ( make sure bot is admin )
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002395713472') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002007085025') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002020924936') # request channel id ( make sure bot is admin )
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Sasukeuchiha')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Rajesh1817')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Rajesh1817')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/rajesh1817') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ʜᴘ')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002058942218')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/rajesh1817') #Support group link ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002385338575'))
